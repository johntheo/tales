      ...
      <main className="container mx-auto px-4 py-12 md:py-16">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-16 text-center">
            <h2 className="text-2xl font-bold mb-4">Ready to elevate your storytelling?</h2>
            <p className="text-[#71717a] mb-6 max-w-2xl mx-auto">
              Join thousands of professionals who are already using Tales to improve their presentations, portfolios,
              and case studies.
            </p>
            <Button
              className="bg-[#09090b] hover:bg-[#18181b] px-8 py-6 h-auto text-base"
