...
export default function SignupPage() {
  ...
  // Array of background images - using different images from login page
  const backgroundImages = [
    "https://picsum.photos/id/60/1200/900",
    "https://picsum.photos/id/65/1200/900",
    "https://picsum.photos/id/68/1200/900",
    "https://picsum.photos/id/76/1200/900",
    "https://picsum.photos/id/91/1200/900",
  ]
  ...
  useEffect(() => {
    if (confirmPassword) {
      ...
      setPasswordMatch(true) // Reset match state when confirm field is empty
    }
        ...
        <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onBlur={handleBlur}
                  required
                  className={`w-full ${!passwordMatch ? "border-red-500 focus:ring-red-500" : ""}`}
                />
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="text-[#09090b] font-medium hover:underline">
                Log in
              </Link>
            </p>
          </div>
